...
#include <memory>
#include "../../../../../lib/qt-material/components/lib/qtmaterialrippleoverlay.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QtMaterialRippleOverlay_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QtMaterialRippleOverlay_t qt_meta_stringdata_QtMaterialRippleOverlay = {
    {
        QT_MOC_LITERAL(0, 23)   // "QtMaterialRippleOverlay"
    },
...
Q_CONSTINIT static const uint qt_meta_data_QtMaterialRippleOverlay[] = {
...
Q_CONSTINIT const QMetaObject QtMaterialRippleOverlay::staticMetaObject = { {
    QMetaObject::SuperData::link<QtMaterialOverlayWidget::staticMetaObject>(),
    qt_meta_stringdata_QtMaterialRippleOverlay.offsetsAndSizes,
    qt_meta_data_QtMaterialRippleOverlay,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QtMaterialRippleOverlay_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QtMaterialRippleOverlay, std::true_type>
    >,
    nullptr
} };
