...
#include <memory>
#include "../../../../../lib/qt-material/components/lib/qtmaterialstyle.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QtMaterialStyle_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QtMaterialStyle_t qt_meta_stringdata_QtMaterialStyle = {
    {
        QT_MOC_LITERAL(0, 15)   // "QtMaterialStyle"
    },
    "QtMaterialStyle"
};
...
Q_CONSTINIT static const uint qt_meta_data_QtMaterialStyle[] = {
...
Q_CONSTINIT const QMetaObject QtMaterialStyle::staticMetaObject = { {
    QMetaObject::SuperData::link<QCommonStyle::staticMetaObject>(),
    qt_meta_stringdata_QtMaterialStyle.offsetsAndSizes,
    qt_meta_data_QtMaterialStyle,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QtMaterialStyle_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QtMaterialStyle, std::true_type>
    >,
    nullptr
} };
