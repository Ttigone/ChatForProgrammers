...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QtMaterialRaisedButton_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QtMaterialRaisedButton_t qt_meta_stringdata_QtMaterialRaisedButton = {
    {
        QT_MOC_LITERAL(0, 22)   // "QtMaterialRaisedButton"
    },
...
Q_CONSTINIT static const uint qt_meta_data_QtMaterialRaisedButton[] = {
...
Q_CONSTINIT const QMetaObject QtMaterialRaisedButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QtMaterialFlatButton::staticMetaObject>(),
    qt_meta_stringdata_QtMaterialRaisedButton.offsetsAndSizes,
    qt_meta_data_QtMaterialRaisedButton,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QtMaterialRaisedButton_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QtMaterialRaisedButton, std::true_type>
    >,
    nullptr
} };
