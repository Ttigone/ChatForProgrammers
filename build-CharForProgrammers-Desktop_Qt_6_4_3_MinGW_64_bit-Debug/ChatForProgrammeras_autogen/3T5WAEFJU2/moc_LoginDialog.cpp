...
#include <memory>
#include "../../../src/LoginPage/LoginDialog.h"
...
Q_CONSTINIT static const qt_meta_stringdata_LoginDialog_t qt_meta_stringdata_LoginDialog = {
    {
        ...
        QT_MOC_LITERAL(12, 9),  // "needLogin"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 13),  // "needSwitchUsr"
        QT_MOC_LITERAL(37, 6),  // "Theme1"
        QT_MOC_LITERAL(44, 4),  // "Dark"
        QT_MOC_LITERAL(49, 5)   // "Light"
    },
    "LoginDialog",
    "needLogin",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_LoginDialog[] = {
 ...
 // enum data: key, value
       5, uint(LoginDialog::Dark),
       6, uint(LoginDialog::Light),
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->needLogin(); break;
        case 1: _t->needSwitchUsr(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginDialog::needLogin; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LoginDialog::*)();
            if (_t _q_method = &LoginDialog::needSwitchUsr; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LoginDialog::needLogin()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void LoginDialog::needSwitchUsr()
{
